...
import { SlothSidebarItem }             from '../sloth-sidebar-item/sloth-sidebar-item.component';
...
export class SlothSidebarComponent implements OnInit, OnDestroy {
    ...
    public sidebar: SlothSidebarItem[] | null = null;
    ...
    ngOnInit (): void {
        this._sidebarService.$sidebar.pipe (takeUntil (this.$onDestroy)).subscribe (
            (sidebar: SlothSidebarItem[] | null) => {
                this.sidebar = sidebar;
            },
        )


        let sidebar: SlothSidebarItem[] = [
            {
                id: 'A',
                text: 'Dashboard',
                type: 'link',
